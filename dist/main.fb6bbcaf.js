...
exports.validatePassword = exports.validateEmail = exports.submitSignUpForm = exports.setFormValue = exports.getValidationStatus = void 0;
var formValues = {}; // Сюда пишутся значения формы (Object как в Java, или dict из Python)
var formValidation = {}; // Сюда пишутся статусы валидации каждого поля. Если поле ни разу не валидировалось,
...
var validatePassword = exports.validatePassword = function validatePassword(e) {
  ...
  formValidation.password = hasUppercase && hasLowercase && hasNumber && hasSpecialChar && isLongEnough;
  return formValidation.password; // Это заглушка, return вероятно надо переписать
};
...
if (password) {
  password.oninput = function (e) {
    var isValid = (0, _utils.setFormValue)(password_id, e.target.value, _utils.validatePassword);
...
if (sign_up_btn) {
  sign_up_btn.onclick = function (e) {
    e.preventDefault();
    var isFormValid = (0, _utils.submitSignUpForm)();
    if (isFormValid) {
