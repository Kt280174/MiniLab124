import {setFormValue, submitSignUpForm, validateEmail, validatePassword, validateConfirmPassword, getValidationStatus} from "./utils.js"
...
const password_confirm = document.getElementById(password_repeat_id);
console.log(password_confirm)
  password_confirm.oninput = (e) => {
  setFormValue(password_repeat_id, e.target.value, validateConfirmPassword);
  checkForm();
}
...
password_confirm.addEventListener('change', onConfirmPasswordChange)
